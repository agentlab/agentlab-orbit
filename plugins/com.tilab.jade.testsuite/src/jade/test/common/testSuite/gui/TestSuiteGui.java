...
import jade.test.common.testSuite.TestSuiteAgent;
import jade.test.common.testerAgentControlOntology.TestResult;
import jade.test.common.TestUtility;
import jade.test.common.TestException;
import jade.test.common.remote.TSDaemon;
import jade.test.common.remote.RemoteManager;
import jade.test.common.xml.*;
import jade.test.common.Logger;
...
public class TestSuiteGui extends javax.swing.JFrame {
  ...
  private jade.test.common.testSuite.gui.CounterPanel    counterPanel;
  private javax.swing.JButton                       debugB;
  private javax.swing.JButton                       exitB;
  private jade.test.common.testSuite.gui.FailedTestsView failedTestsView;
  ...
  private jade.test.common.testSuite.gui.ProgressBar     progressBar;
  ...
  private jade.test.common.xml.TestsTree                 testsTree;
  ...
  public TestSuiteGui(TestSuiteAgent myAgent, String xmlFileName) {
    ...
    jStatusLabel.setText("Current logger type: "+jade.test.common.Logger.getLoggerStringType()+", click on Logger button to change it");
  }
  ...
  private void initComponents() {    // GEN-BEGIN:initComponents
    ...
    progressBar = new jade.test.common.testSuite.gui.ProgressBar();
    jSplitPane = new javax.swing.JSplitPane();
    failedTestsView = new jade.test.common.testSuite.gui.FailedTestsView();
    testsTree = new jade.test.common.xml.TestsTree();
    ...
    counterPanel = new jade.test.common.testSuite.gui.CounterPanel();
